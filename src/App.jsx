  ...
  if (step === 'welcome') return (
    <div style={s.app}>
      ...
      <div style={s.center}>
        ...
        <p style={{color:G.muted,lineHeight:1.75,fontSize:'1rem',maxWidth:440,margin:'0 auto 2.25rem'}}>
          Sign in with your email to save your ratings and get matched with real taste twins.
        </p>
